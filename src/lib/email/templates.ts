...
export const getPaymentEmail = (name: string, appNo: string, amount: number) => ({
  subject: `Payment Successful - ${appNo} | MTU Admissions`,
  html: `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #334155;">
      ...
      <p>You can now download your finalized application form from the dashboard.</p>
